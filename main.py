...
for countour in contours:
    ...
    print(f"casuality no.{total_casuality}, severity score - {severity}, age score - {age} , priority score - {severity*age}, location - ({int(x+w/2)} , {int(y+h/2)}), elevation detected - {detected_elevation}")
